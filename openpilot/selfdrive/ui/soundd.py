  ...
  def load_sounds(self):
    ...
    for sound in sound_list:
      ...
      stock_path = (BASEDIR + "/openpilot/selfdrive/assets/sounds/" + filename
                    if os.path.exists(BASEDIR + "/openpilot/selfdrive/assets/sounds/" + filename)
                    else BASEDIR + "/selfdrive/assets/sounds/" + filename)
...
<<<<<<< HEAD:openpilot/selfdrive/ui/soundd.py
...
>>>>>>> origin/bp-dev:selfdrive/ui/soundd.py
